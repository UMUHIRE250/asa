    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <Cardslider title={"On Menu"} data={foodData} navigation={navigation} />
                <Cardslider title={"Dessert"} data={NonVegData} navigation={navigation} />
                <Cardslider title={"Our Best"} data={VegData} navigation={navigation} />
            </ScrollView>
